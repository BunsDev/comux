...
/**
 * Standalone popup for creating a new vmux pane
...
const DEBUG_LOG = path.join(FILE_SCAN_ROOT, '.vmux', 'file-picker-debug.log')
    ...
    >
      <PopupContainer footer={PopupFooters.input()}>
        ...
        <Box marginBottom={0}>
          ...
          <Text bold color={POPUP_CONFIG.titleColor}>{PROJECT_NAME}</Text>
