  ...
  return (
    <Box flexDirection="column">
      ...
      <Box justifyContent="space-between">
        <Text>
          <Text>🪵 </Text>
          <Text color={COLORS.accent}>[l]</Text>
          <Text bold>ogs</Text>
          <Text dimColor>  •  </Text>
      ...
      {/* Keyboard shortcuts */}
      <Text dimColor>
        Press <Text color={COLORS.accent}>[?]</Text> for keyboard shortcuts
      </Text>

      {focusHint && (
        <Text dimColor wrap="truncate-end">
          <Text color={COLORS.accent}>Focus:</Text> {focusHint}
        </Text>
      )}

      {footerTip && (
        <Text dimColor wrap="truncate-end">
          <Text color={COLORS.success}>Tip:</Text> {footerTip}
        </Text>
      )}
