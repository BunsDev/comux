    ...
    startConflictMonitoring({
      ...
      onResolved: async () => {
        ...
        try {
          ...
          const panesWithoutConflictPane = currentPanes.filter((p: VmuxPane) => p.id !== conflictPane.id);
          ...
          if (!mergeResult.success) {
            ...
            await triggerHook('post_merge', worktree.parentRepoPath, pane, {
              ...
              VMUX_WORKTREE_PATH: worktree.worktreePath,
              VMUX_REPO_NAME: worktree.repoName,
            });
          }
