...
export const NOTIFICATION_SOUND_DEFINITIONS: readonly NotificationSoundDefinition[] = [
  ...
  },
  {
    id: 'braam',
    label: 'Braam',
    resourceFileName: 'vmux-braam.caf',
    defaultEnabled: false,
  },
  {
    id: 'brass',
    label: 'Brass',
    resourceFileName: 'vmux-brass.caf',
    defaultEnabled: false,
  },
  {
    id: 'ding-bell',
    label: 'Ding Bell',
    resourceFileName: 'vmux-ding-bell.caf',
    defaultEnabled: false,
  },
  {
    id: 'future',
    label: 'Future',
    resourceFileName: 'vmux-future.caf',
    defaultEnabled: false,
  },
  {
    id: 'harp',
    label: 'Harp',
    resourceFileName: 'vmux-harp.caf',
    defaultEnabled: false,
  },
  {
    id: 'quiet-bells',
    label: 'Quiet Bells',
    resourceFileName: 'vmux-quiet-bells.caf',
    defaultEnabled: false,
  },
  {
    id: 'sonar',
    label: 'Sonar',
    resourceFileName: 'vmux-sonar.caf',
    defaultEnabled: false,
  },
  {
    id: 'success',
    label: 'Success',
    resourceFileName: 'vmux-success.caf',
    defaultEnabled: false,
  },
  {
    id: 'triumphant-trumpet',
    label: 'Triumphant Trumpet',
    resourceFileName: 'vmux-triumphant-trumpet.caf',
    defaultEnabled: false,
  },
  {
    id: 'war-horn',
    label: 'War Horn',
    resourceFileName: 'vmux-war-horn.caf',
    defaultEnabled: false,
  },
] as const;
