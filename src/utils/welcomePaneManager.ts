...
/**
 * LEGACY: Ensures a welcome pane exists when there are no vmux panes
 *
 ...
 * @param projectRoot - The project root directory
 * @param controlPaneId - The control pane ID
 * @param panesCount - Number of active vmux panes
 */
export async function ensureWelcomePane(
  ...
  // Only create welcome pane if there are no vmux panes
