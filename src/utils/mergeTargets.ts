...
function getDefaultMergeTarget(pane: VmuxPane): MergeTargetResolution | null {
...
export function resolveMergeTarget(pane: VmuxPane): MergeTargetResolution | null {
...
export function buildMissingMergeTargetMessage(pane: VmuxPane): string {
