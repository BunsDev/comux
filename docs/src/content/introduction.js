    ...
    <div class="sa-banner">
      <div class="sa-banner-inner">
        <div class="sa-banner-content">
          ...
          <p class="sa-description">comux is local-first infrastructure for managing parallel agent work. The docs below are the release surface: start with the workflow map, then use troubleshooting and configuration when you need to understand a project setup.</p>
