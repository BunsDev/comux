...
describe('paneProject helpers', () => {
  ...
  it('derives root from worktree path when metadata is missing', () => {
    const pane: ComuxPane = {
      ...
      prompt: 'test',
      paneId: '%1',
      worktreePath: '/workspace/root-c/.comux/worktrees/feature-a',
    };
  ...
  it('resolves project display names', () => {
    ...
    const derivedNamePane: ComuxPane = {
      id: 'comux-2',
      slug: 'feature-b',
      prompt: 'test',
      paneId: '%2',
      worktreePath: '/workspace/project-y/.comux/worktrees/feature-b',
    };
