...
import { VmuxAttentionService } from '../src/services/VmuxAttentionService.js';
...
describe('VmuxAttentionService', () => {
  ...
  it('suppresses startup attention notifications until pane activity is observed', async () => {
    ...
    const service = new VmuxAttentionService({ focusService: focusService as any });
